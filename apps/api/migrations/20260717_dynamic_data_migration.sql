...
-- Seed mkw_handbook_pages
INSERT INTO mkw_handbook_pages (id, category, title, content, audience, bullets)
...
-- 2. Create mkw_english_island_items
CREATE TABLE IF NOT EXISTS mkw_english_island_items (
  id VARCHAR(50) PRIMARY KEY,
...
-- Seed mkw_english_island_items
INSERT INTO mkw_english_island_items (id, district_id, type, prompt, options, correct_answer, accepted_answers, explanation, speech_text)
VALUES (
  'pv-1', 
  'phrase-valley', 
  'choice', 
...
-- 3. Create mkw_subject_exam_blueprints
CREATE TABLE IF NOT EXISTS mkw_subject_exam_blueprints (
...
-- Seed mkw_subject_exam_blueprints
