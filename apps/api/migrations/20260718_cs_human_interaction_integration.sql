-- SQL migration to link lessons and questions for cs_human_interaction (grade_tier = 13)
...
VALUES
  ...
  ('act-boss-cs_humint_03', 'multimodal-interaction', 'boss', 'Thử thách Boss: Thần chùm Beamforming ❄️', '{"boss_id": "boss_humint_beam", "hp": 500, "time_limit": 1000}'::jsonb, 100, 75, 150, 'cs_human_interaction', 13),
  ('act-boss-cs_humint_04', 'safe-zones', 'boss', 'Thử thách Boss: Chúa tể SIL3 🌀', '{"boss_id": "boss_humint_sil", "hp": 550, "time_limit": 1100}'::jsonb, 100, 85, 170, 'cs_human_interaction', 13)
