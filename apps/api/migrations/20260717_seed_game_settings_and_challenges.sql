...
CREATE TABLE IF NOT EXISTS mkw_challenge_templates (
...
INSERT INTO mkw_challenge_templates (id, type, title, description, target_count, reward_ruby, reward_xp, category, sort_order)
SELECT * FROM (VALUES
...
WHERE NOT EXISTS (SELECT 1 FROM mkw_challenge_templates);
